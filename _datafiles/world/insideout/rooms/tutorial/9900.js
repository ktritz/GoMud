...
function onEnter(user, room) {
    ...
    teacherMob.Command('say Welcome! You\'ve just popped into existence inside Riley\'s mind. Pretty wild, right?', 1.0);
    teacherMob.Command('say I\'m an Orb of Vision. I\'ll teach you the basics before you head out into the real world.', 3.0);
    teacherMob.Command('say First things first -- let\'s learn how to look around. Type <ansi fg="command">look</ansi> and hit enter.', 5.0);
