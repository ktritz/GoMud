...
function onCommand(cmd, rest, user, room) {
    ...
    if ( teach_commands[commandNow] == fullCommand ) {
        ...
        if ( cmd == "inventory" ) {
            teacherMob.Command('say Hmm, it doesn\'t look like you\'re carrying much other than that pencil. Hey, it\'s mightier than the sword!', 2.0);
...
function onEnter(user, room) {
    ...
    // Give the player a pencil right away
    if ( !user.HasItemId(firstItemId) ) {
        itm = CreateItem(firstItemId);
        user.GiveItem(itm);
    }
    ...
    teacherMob.Command('say Hi! I\'m the Orb of Reflection. I\'m here to help you understand yourself -- the emotions, the stats, all of it.', 1.0);
    teacherMob.Command('say Oh, and here -- take this pencil. You\'ll need something to defend yourself out there.', 2.0);
    teacherMob.Command('say To get a detailed view of a LOT of information all at once, type <ansi fg="command">status</ansi> and hit enter.', 4.0);
